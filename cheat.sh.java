...
// Anonymous classes: when you need a class that is inherited from an interface but
// you don't want to create one ususal way (or to avoid a lot of boilerplate)

// Here's the interface the object inherited from we want to create
